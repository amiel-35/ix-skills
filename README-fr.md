...
| id | Rôle |
|---|---|
| `critique` | Identifier les failles d'un contenu sans proposer de solution |
| `correction` | Transformer une critique en directives actionnables |
| `simplify` | Épurer un contenu sans changer le fond |
| `rephrase` | Restituer le sens réel d'un contenu dense ou ambigu |
| `explorer` | Générer un espace d'options sans trancher |
| `decision` | Arbitrer avec trade-offs visibles et recommandation nette |
| `deliver` | Transformer un artifact en livrable partageable |
